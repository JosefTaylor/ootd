...
import { API, createGarment, createWear, deleteWear, getDashboardData, updateGarment } from "../axiosApi.jsx";
  ...
  return (
    <div className="wrapper stack pad-1 wd-max ht-full">
      ...
      <Card className="ht-two-thirds ht-225-min" title="Your Wardrobe">
        ...
        <WardrobeGarment
          garment={{ name: filterText, purchase_date: daySelected.toISOString().split('T')[0] }}
          mode={"new"}
          newName={filterText}
          onSave={(newGarment) => {
